...
docker tag dbgdave/dave-store-manager:${CIRCLE_SHA1} docker.io/dbgdave/dave-store-manager:${CIRCLE_SHA1}
docker push dbgdave/dave-store-manager:${CIRCLE_SHA1}
docker tag dbgdave/dave-store-manager:${CIRCLE_SHA1} docker.io/dbgdave/dave-store-manager:${CIRCLE_BRANCH}
