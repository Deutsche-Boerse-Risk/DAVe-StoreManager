...
import com.deutscheboerse.risk.dave.mongo.codec.ModelCodecProvider;
...
public class MongoBulkClientOptionsParser {
  ...
  public MongoBulkClientOptionsParser(JsonObject config) {
